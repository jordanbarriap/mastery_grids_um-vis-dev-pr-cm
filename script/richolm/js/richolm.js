...
function topicNodeMouseOver(tid,origin) {
  ...
  d3.selectAll(".bar").filter(function(d){return correctTopicName(d.t)==tid}).classed("active", true);
  ...
  d3.selectAll(".nodename").filter(function(d){return correctTopicName(d.t)==tid}).classed("active", true);
  //d3.selectAll(".nodename").filter(function(d){return d.t==tid}).classed("active", true);//Commented by @Jordan
  d3.selectAll(".text-userbar").filter(function(d){return correctTopicName(d.t)==tid}).classed("active", true);
